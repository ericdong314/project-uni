# Generated by Django 5.2.17 on 2026-08-29 08:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Enter a language (e.g. English, Chinese, German, etc.)', max_length=50, unique=True)),
            ],
            options={
